 ...
 * </ul>
 */
public class TestKeySetOnEmptyMapAdapter {
...
\* ================================================================================================================= */
	...
	/**
	 * Costruttore predefinito per la classe {@code TestKeySetOnEmptyKeySet}.
	 * Questa classe è un'utility e non richiede un'inizializzazione di stato complessa.
	 */
	public TestKeySetOnEmptyMapAdapter() {
		// intentionally left empty
	}

	/**
	 * Metodo di setup che viene eseguito prima di ogni test.
	 * Inizializza un'istanza di {@code MapAdapter} che rappresenta una mappa vuota da cui ottiene un'istanza di {@code KeySetAdapter}
	 * che rappresenta la vista per chiavi (anch'essa vuota) e un'istanza di {@code KeySetIterator} per l'iteratore della vista.
	 */
	@Before
	public void setUp() {
		map = new MapAdapter();
	 ...
	 */
	@Test
	public void testSizeOnEmptyKeySet() {
		assertEquals("La vista dovrebbe avere 0 elementi", 0, keySet.size());
	}
	 ...
	 */
	@Test
	public void testIsEmptyOnEmptyKeySet() {
		assertTrue("La vista dovrebbe essere vuota", keySet.isEmpty());
	}
	 ...
	 */
	@Test
	public void testContainsOnEmptyKeySet() {
		assertFalse("contains dovrebbe restituire false se invocato su una vista vuota",
				keySet.contains("a_random_key"));
	}
	...
	public void testContainsNullOnEmptyKeySet() {
	 ...
	 */
	@Test
	public void testIteratorOnEmptyKeySet() {
	 ...
	 */
	@Test
	public void testToArray1OnEmptyKeySet() {
		assertTrue("La vista dovrebbe restituire un array di Object", keySet.toArray() instanceof Object[]);
		assertEquals("La vista dovrebbe restituire un array di lunghezza 0", 0, keySet.toArray().length);
	}
	 ...
	 * <p>
	 * <b>Expected Results:</b>
	 * Il metodo {@code toArray(Object[] a)} dovrebbe restituire un array uguale a quello passato come parametro, con il primo
	 * elemento impostato a {@code null}.
	 */
	@Test
	public void testToArray2OnEmptyKeySet() {
	 ...
	 */
	@Test(expected = NullPointerException.class)
	public void testToArray2NullArrayOnEmptyKeySet() {
		Object[] array = null;
	 ...
	 * <p>
	 * <b>Post-Condition:</b>
	 * Il metodo {@code toArray(Object[] a)} è stato chiamato con un array {@code null} come parametro e non ha alterato
	 * l'array passato come parametro.
	 * 
	 * <p>
	 * <b>Expected Results:</b>
	 ...
	 */
	@Test
	public void testToArray2EmptyArrayOnEmptyKeySet() {
		Object[] array = new Object[0];
		assertTrue("L'array restituito dovrebbe essere lo stesso array passato come parametro",
				array == keySet.toArray(array));
		assertTrue("L'array restituito dovrebbe rimanere vuoto", array.length == 0);
	}
	 ...
	 * <p>
	 * <b>Test Case Design:</b>
	 * Il metodo {@code add(Object o)} è disabilitato per le viste di una mappa vuota e lancia una
	 ...
	 * <p>
	 * <b>Post-Condition:</b>
	 * Il metodo {@code add(Object o)} è stato chiamato e ha lanciato una {@code UnsupportedOperationException}.
	 * 
	 * <p>
	 * <b>Expected Results:</b>
	...
	public void testAddOnEmptyKeySet() {
		keySet.add("a_random_key"); // lancia UnsupportedOperationException
	}
	 ...
	 * <p>
	 * <b>Expected Results:</b>
	 * Il metodo {@code remove(Object o)} dovrebbe restituire {@code false} se l'oggetto non è presente nella vista.
	 * Inoltre la vista (e di conseguenza la mappa) dovrebbe rimanere vuota e con 0 elementi.
	 */
	@Test
	public void testRemoveOnEmptyKeySet() {
		assertFalse("remove dovrebbe restituire false se invocato su una vista vuota", keySet.remove("a_random_key"));
		assertTrue("La vista dovrebbe rimanere vuota", keySet.isEmpty());
		assertEquals("La vista dovrebbe avere 0 elementi", 0, keySet.size());
	 ...
	 */
	@Test (expected = NullPointerException.class)
	public void testRemoveNullKeyOnEmptyKeySet() {
	 ...
	 */
	@Test
	public void testContainsAllEmptyCollectionOnEmptyKeySet() {
		MapAdapter newEmptyMap = new MapAdapter();
		HCollection emptyCollection = newEmptyMap.values();
		assertTrue("La vista dovrebbe contenere tutti gli elementi della collezione vuota",
				keySet.containsAll(emptyCollection));
	}
	 ...
	 */
	@Test(expected = NullPointerException.class)
	public void testContainsAllNullCollectionOnEmptyKeySet() {
	...
	public void testContainsAllPopulatedCollectionOnEmptyKeySet() {
		...
		assertFalse("La vista non dovrebbe contenere tutti gli elementi della collezione non vuota",
				keySet.containsAll(populatedCollection));
	}
	 ...
	 * <p>
	 * <b>Test Case Design:</b>
	 * Il metodo {@code addAll(HCollection c)} è disabilitato per le viste di una mappa vuota e lancia una
	 ...
	 */
	@Test(expected = UnsupportedOperationException.class)
	public void testAddAllOnEmptyKeySet() {
	 ...
	 * restituire {@code false} in quanto non ci sono entry rimovibili dalla lista.
	 * 
	 * <p>
	 * <b>Pre-Condition:</b>
	 * Il metodo {@code setUp()} è stato eseguito, creando una nuova istanza della vista {@code KeySetAdapter}
	 ...
	 * <p>
	 * <b>Expected Results:</b>
	 * Il metodo {@code removeAll(HCollection c)} dovrebbe restituire {@code false} se la collezione è vuota.
	 * Inoltre la vista (e di conseguenza la mappa) dovrebbe rimanere vuota e con 0 elementi.
	 */
	@Test
	public void testRemoveAllEmptyCollectionOnEmptyKeySet() {
	 ...
	 * <b>Pre-Condition:</b>
	 * Il metodo {@code setUp()} è stato eseguito, creando una nuova istanza della vista {@code KeySetAdapter}
	 * collegata a una mappa vuota.. Viene creata un nuovo riferimento di tipo {@code HCollection} per generare una
	 ...
	 */
	@Test(expected = NullPointerException.class)
	public void testRemoveAllNullCollectionOnEmptyKeySet() {
		HCollection nullCollection = null;
	 ...
	 * <p>
	 * <b>Expected Results:</b>
	 * Il metodo {@code removeAll(HCollection c)} dovrebbe restituire {@code false} se la collezione è non vuota.
	 * Inoltre la vista (e di conseguenza la mappa) dovrebbe rimanere vuota e con 0 elementi.
	 */
	@Test
	public void testRemoveAllPopulatedCollectionOnEmptyKeySet() {
		...
		assertFalse("removeAll dovrebbe restituire false se la collezione è non vuota", keySet.removeAll(populatedCollection));
		assertTrue("La vista dovrebbe rimanere vuota", keySet.isEmpty());
		assertEquals("La vista dovrebbe avere 0 elementi", 0, keySet.size());
		assertTrue("La mappa associata alla vista dovrebbe essere vuota", map.isEmpty());
		assertEquals("La mappa associata alla vista dovrebbe avere 0 elementi", 0, map.size());
	 ...
	 * <p>
	 * <b>Expected Results:</b>
	 * Il metodo {@code retainAll(HCollection c)} dovrebbe restituire {@code false} se la collezione è vuota.
	 * Inoltre la vista (e di conseguenza la mappa) dovrebbe rimanere vuota e con 0 elementi.
	 */
	@Test
	public void testRetainAllEmptyCollectionOnEmptyKeySet() {
		HCollection emptyCollection = new MapAdapter().values();
		assertFalse("retainAll dovrebbe restituire false se la collezione è vuota", keySet.retainAll(emptyCollection));
		assertTrue("La vista dovrebbe rimanere vuota", keySet.isEmpty());
		assertEquals("La vista dovrebbe avere 0 elementi", 0, keySet.size());
		assertTrue("La mappa associata alla vista dovrebbe essere vuota", keySet.isEmpty());
		assertEquals("La mappa associata alla vista dovrebbe avere 0 elementi", 0, keySet.size());
	}
	 ...
	 */
	@Test(expected = NullPointerException.class)
	public void testRetainAllNullCollectionOnEmptyKeySet() {
		HCollection nullCollection = null;
	 ...
	 * <p>
	 * <b>Expected Results:</b>
	 * Il metodo {@code retainAll(HCollection c)} dovrebbe restituire {@code false} se la collezione è non vuota.
	 * Inoltre la vista (e di conseguenza la mappa) dovrebbe rimanere vuota e con 0 elementi.
	 */
	@Test
	public void testRetainAllPopulatedCollectionOnEmptyKeySet() {
		MapAdapter newPopulatedMap = new MapAdapter();
		newPopulatedMap.put("key1", "value1"); // aggiunge una entry generica
		HCollection populatedCollection = newPopulatedMap.values();
		assertFalse("retainAll dovrebbe restituire false se la collezione è non vuota",
				keySet.retainAll(populatedCollection));
		assertTrue("La vista dovrebbe rimanere vuota", keySet.isEmpty());
		assertEquals("La vista dovrebbe avere 0 elementi", 0, keySet.size());
		assertTrue("La mappa associata alla vista dovrebbe essere vuota", keySet.isEmpty());
		assertEquals("La mappa associata alla vista dovrebbe avere 0 elementi", 0, keySet.size());
	 ...
	 * la chiamata a questo metodo, la  vista (e di conseguenza dalla mappa) dovrebbe essere vuota.
	 * 
	 * <p>
	 * <b>Test Description:</b>
	...
	public void testHashOnEmptyMap() {
		...
		assertEquals("L'hash code della mappa vuota dovrebbe essere 0", 0, keySet.hashCode());
		assertTrue("L'hash code di due mappe vuote dovrebbe essere lo stesso",
				keySet.hashCode() == newEmptyKeySet.hashCode());
	}
	 ...
	 * <p>
	 * <b>Test Case Design:</b>
	 * Il metodo {@code equals(Object o)} verifica se l'oggetto passato come parametro è uguale alla vista KeySet
	 * corrente. Due KeySet sono considerati uguali se sono entrambi delle istanze della classe {@code KeySetAdapter}
	 * e contengono gli stessi elementi (stessi oggetti chiave). Restituisce {@code false} se il parametro è {@code null},
	 * se il parametro non è una keySet o se contiene elementi diversi.
	 * 
	 * <p>
	 * <b>Test Description:</b>
	 ...
	 * <p>
	 * <b>Expected Results:</b>
	 * Il metodo {@code equals(Object o)} dovrebbe restituire {@code false} se il parametro è {@code null}.
	 */
	@Test
	public void testEqualsNullOnEmptyKeySet() {
	 ...
	 * <p>
	 * <b>Expected Results:</b>
	 * Il metodo {@code equals(Object o)} dovrebbe restituire {@code false} se il parametro non è una {@code KeySetAdapter}.
	 */
	@Test
	public void testEqualsNotKeySetOnEmptyKeySet() {
		String notAKeySet = "This is not a KeySet";
		assertFalse("equals dovrebbe restituire false se gli viene passato un oggetto che non è una KeySet",
				keySet.equals(notAKeySet));
	}
	 ...
	 */
	@Test
	public void testEqualsOtherViewsOnEmptyKeySet() {
		HCollection valuesView = new MapAdapter().values();
		HSet entrySetView = new MapAdapter().entrySet();
		assertFalse("equals dovrebbe restituire false se gli viene passato un oggetto che non è una KeySet",
				keySet.equals(valuesView));
		assertFalse("equals dovrebbe restituire false se gli viene passato un oggetto che non è una KeySet",
				keySet.equals(entrySetView));
	}
	 ...
	 * <p>
	 * <b>Post-Condition:</b>
	 * Il metodo {@code equals(Object o)} è stato chiamato con una nuova istanza di {@code KeySetAdapter} collegata a un
	 *  mappa vuota.
	 * 
	 * <p>
	 * <b>Expected Results:</b>
	 ...
	 */
	@Test
	public void testEqualsNewEmptyKeySetOnEmptyKeySet() {
		HSet newEmptyKeySet = new MapAdapter().keySet();
		assertTrue("equals dovrebbe restituire true se gli viene passato un'altro keySet vuoto",
				keySet.equals(newEmptyKeySet));
	}
	 ...
	 */
	@Test
	public void testEqualsPopulatedKeySetOnEmptyKeySet() {
		MapAdapter populatedMap = new MapAdapter();
		populatedMap.put("key", "value");
		HSet populatedKeySet = populatedMap.keySet();
		assertFalse("equals dovrebbe restituire false se gli viene passata una KeySet con entry diverse",
				keySet.equals(populatedKeySet));
	}
	...
	public void testToStringOnEmptyMap() {
		assertEquals("La rappresentazione in stringa di una mappa vuota dovrebbe essere []", "[]", keySet.toString());
	}
...
\* ================================================================================================================= */
	...
	public void testHasNextOnEmptyKeySetIterator() {
		assertFalse("hasNext dovrebbe restituire false per un iteratore associato a una vista vuota",
	 ...
	 * vista vuota, dovrebbe generare un'eccezione {@code java.util.NoSuchElementException} in quanto non c'è nessun
	 ...
	 * <p>
	 * <b>Expected Results:</b>
	 * Il metodo {@code next()} dovrebbe generare un'eccezione {@code java.util.NoSuchElementException}.
	 */
	@Test (expected = java.util.NoSuchElementException.class)
	public void testNextOnEmptyKeySetIterator() {
	 ...
	 * un iteratore associato a una vista vuota, dovrebbe generare un'eccezione {@code myAdapter.IllegalStateException}
	 ...
	 * <p>
	 * <b>Expected Results:</b>
	 * Il metodo {@code remove()} dovrebbe generare un'eccezione {@code myAdapter.IllegalStateException}.
	 */
	@Test (expected = myAdapter.IllegalStateException.class)
	public void testRemoveOnEmptyKeySetIterator() {
