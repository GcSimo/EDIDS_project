...
public interface HMap {
	 ...
	 * @throws IllegalArgumentException if some aspect of a key or value in the
	 *			  specified map prevents it from being stored in this map.
	 ...
	 * the map, via the {@code HIterator.remove}, {@code HSet.remove},
	 ...
	 * represent the same mappings. More formally, two maps {@code t1} and
	 ...
	 * entrySet view. This ensures that {@code t1.equals(t2)} implies
	 * that {@code t1.hashCode()==t2.hashCode()} for any two maps
	 * {@code t1} and {@code t2}, as required by the general
	...
	public static interface HEntry {
		 ...
		 * implementations of the {@code HMap.HEntry} interface.
		 *
