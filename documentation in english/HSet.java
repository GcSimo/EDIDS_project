 ...
 *
 * The {@code HSet} interface places additional stipulations, beyond those
 * inherited from the {@code HCollection} interface, on the contracts of all
 ...
 * declarations have been tailored to the {@code HSet} interface, but they do
...
public interface HSet extends HCollection {
     ...
     * element {@code e} such that {@code (o==null ? e==null :
     * o.equals(e))}.
     *
     ...
     * Obeys the general contract of the {@code HCollection.toArray} method.
     *
     ...
     * {@code HCollection.toArray(Object[])} method.
     *
     ...
     * {@code e} such that {@code (o==null ? e==null :
     * o.equals(e))}. If this set already contains the specified element,
     * the call leaves this set unchanged and returns {@code false}.
     ...
     * {@code null}, and throwing an exception, as described in the
     * specification for {@code HCollection.add}. Individual set
     * implementations should document clearly any restrictions on the the
